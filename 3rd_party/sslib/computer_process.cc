...
bool ComputerProcess::StartProcess(const wstring &cmdline)
{
    ...
    //return true;
#ifdef _WIN32
    HINSTANCE ret_code = ShellExecute(nullptr, nullptr, std::string(cmdline.begin(), cmdline.end()).c_str(),
...
bool ComputerProcess::ListProcesses_Win(vector<ProcessData> &process_list)
{
    ...
    do
    {
        ...
        proc_data.cmdline = std::wstring(pe32.szExeFile, pe32.szExeFile+MAX_PATH);
